...
ADD COLUMN customer_email VARCHAR(100) DEFAULT NULL AFTER customer_name;
...
('pickup_ready_subject','Enter subject for pickup-ready alert'),
('pickup_ready_body','Enter body for pickup-ready alert');
